                              ...
                              ${clientEntries.map((entry) => {
                                return html`
                                  <tr class="border-t border-border-subtle hover:bg-bg-surface-raised transition-colors">
                                    ...
                                    <td class="px-4 py-3 text-text-secondary">${entry.date}</td>
                                    <td class="px-4 py-3 text-right text-text-secondary">${entry.duration.toFixed(1)}h</td>
                                    <td class="px-4 py-3 text-text-muted text-xs">${entry.description || "—"}</td>
                                    <td class="px-4 py-3 text-center">
                                      <a href="/zeiten/${entry.id}" class="text-primary hover:underline text-xs">
                                        Bearbeiten
                                      </a>
                                    </td>
                                  </tr>
        ...
        <div>
          <div class="flex items-center">
            <input
              ...
              class="h-4 w-4 accent-primary rounded border-border-medium"
