...
import { dunningRoutes, dunningSettingsRoutes } from "./routes/dunning";
...
app.use("/mahnwesen/*", navContextMiddleware);
...
app.route("/mahnwesen", dunningRoutes);
app.route("/einstellungen/mahnwesen", dunningSettingsRoutes);
